        ...
        >
          <div className="mx-auto max-w-[920px]">
            ...
            {content.subtitle != null && (
              <p
                {...e("text", "subtitle")}
                className={`text-center mt-4 ${sv(content.subtitleFont) || "font-manrope"} ${editing ? EDIT_HOVER : ""}`}
                style={{
                  fontSize: px(content.subtitleSize) || "16px",
                  color: sv(content.subtitleColor) || "#6B7078",
                }}
              >
                {t(tVal(content, "subtitle", lang))}
              </p>
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="rounded-[20px] p-6" style={{ backgroundColor: "#F7F1E7" }}>
                <input className="w-full px-4 py-3 rounded-[10px] text-[14px] mb-3" style={{ backgroundColor: "#FFFFFF", border: "1px solid #CFD2D8" }} placeholder="Your name" />
                <input className="w-full px-4 py-3 rounded-[10px] text-[14px] mb-3" style={{ backgroundColor: "#FFFFFF", border: "1px solid #CFD2D8" }} placeholder="Phone or email" />
                <textarea className="w-full px-4 py-3 rounded-[10px] text-[14px] resize-none h-24" style={{ backgroundColor: "#FFFFFF", border: "1px solid #CFD2D8" }} placeholder="How can we help?" />
                <button
                  className="mt-4 w-full text-white font-bold py-3 rounded-[10px]"
                  style={{ backgroundColor: sv(content.buttonColor) || "#CBA07D", color: sv(content.buttonTextColor) || "#FFFFFF" }}
                >
                  {t(tVal(content, "primaryBtn", lang))}
                </button>
              </div>
              <div className="flex flex-col justify-center space-y-6">
                <div>
                  <p className="text-[12px] uppercase tracking-wider text-[#6B7078] mb-1">Phone</p>
                  <p className="text-[18px] font-semibold text-[#1F1D1B]">{t(tVal(content, "phone", lang))}</p>
                </div>
                <div>
                  <p className="text-[12px] uppercase tracking-wider text-[#6B7078] mb-1">Email</p>
                  <p className="text-[18px] font-semibold text-[#1F1D1B]">{t(tVal(content, "email", lang))}</p>
                </div>
                <div>
                  <p className="text-[12px] uppercase tracking-wider text-[#6B7078] mb-1">Address</p>
                  <p className="text-[18px] font-semibold text-[#1F1D1B]">{t(tVal(content, "address", lang))}</p>
                </div>
                <div>
                  <p className="text-[12px] uppercase tracking-wider text-[#6B7078] mb-1">Hours</p>
                  <p className="text-[18px] font-semibold text-[#1F1D1B]">{t(tVal(content, "workHours", lang))}</p>
                </div>
              </div>
            </div>
          </div>
