...
const cards = [
  {
    ...
    text: "The extra-large 12×12 mm spot treats large areas — full legs in under 15 minutes, full back in under 20. Your lunch break is enough",
  },
  {
    title: "Virtually Painless",
    text: "Integrated sapphire cooling and vacuum-assisted technology minimize sensation to a gentle warmth",
  },
  {
    title: "Safe For All Skin Types",
    text: "Blended 810nm and 940nm wavelengths penetrate at optimal depths for melanin absorption while protecting darker skin tones",
  },
  {
  ...
  {
    title: "No More Ingrowns",
    text: "By destroying the follicle, Primelase ends the cycle of ingrown hairs, razor bumps, and irritation — especially transformative for bikini",
  },
];
...
export default function PrimelaseBenefits({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={cmsImage || "/primelase-benefits.webp"}
