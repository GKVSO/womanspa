...
const cards = [
  {
    title: "No Needles, No Numbing, No Downtime",
    text: "Walk in, receive a comfortable treatment, and return to your life immediately. No numbing cream, no recovery period, no hiding",
  },
  {
  ...
  },
  {
    ...
    text: "Real-time impedance analysis tailors energy delivery to your skin, ensuring precise and personalized treatment",
  },
  {
    title: "Comfortable Never-Numb Experience",
    text: "Wave Fit Pulse and ICD cooling keep skin comfortable and protected for a warm, pain-free experience",
  },
  {
    title: "Visible, Progressive Tightening",
    text: "Collagen remodeling occurs over weeks and months post-treatment. Skin gradually looks firmer, smoother, and more lifted - naturally",
  },
  {
    title: "Short Treatment Time",
    text: "Sessions typically last 15 to 30 minutes, making XERF easy to fit into even the busiest schedule",
  },
];
...
export default function XerfBenefits({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="/xerf-benefits.png"
          alt={t("Xerf results")}
          width={1020}
          height={793}
          className="h-auto w-[50%] min-[1200px]:w-[60%]"
        />
      </motion.div>
