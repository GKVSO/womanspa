...
const cards = [
  {
    ...
    text: "Supports natural cellular energy production to help improve daily vitality.",
  },
  {
    title: "Healthy Aging Support",
    text: "Helps support cellular repair associated with healthy aging and wellness",
  },
  {
    title: "Mental Clarity & Focus",
    text: "May help improve focus, mental clarity, and cognitive performance",
  },
  {
    title: "Recovery & Performance",
    text: "Supports recovery after travel, stress, workouts, or demanding schedules",
  },
  {
    title: "Metabolic Wellness",
    text: "Supports healthy metabolism and efficient cellular energy production",
  },
  {
    title: "Overall Vitality",
    text: "Designed to promote lasting energy, resilience, and overall wellness",
  },
];
...
export default function NadTherapyBenefitsGrid({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    ...
    >
      ...
      <div ref={cardsRef} className="relative z-20 -mt-8 min-[768px]:-mt-[100px] w-full">
        <div
          className="absolute size-1/3 top-0 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-full blur-[10px] opacity-90 bg-[#CBA07D]"
        />
