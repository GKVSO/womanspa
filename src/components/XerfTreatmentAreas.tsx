...
const areas = [
  {
    ...
    text: "Helps fine lines and lax skin around the eye area and forehead look firmer",
    side: "left",
  ...
  {
    label: "Arms",
    text: "Helps improve the appearance of mild skin laxity and uneven skin texture on the upper arms",
    side: "left",
  ...
  },
  {
    ...
    text: "Supports firmer-looking skin in the thigh and knee areas where mild laxity or uneven texture may be present",
    side: "left",
  ...
  },
  {
    ...
    text: "Helps tighten lax cheeks, soften heaviness near the nasolabial area, and make the jawline look clearer",
    side: "right",
  ...
  {
    label: "Buttocks",
    text: "Supports smoother and firmer-looking skin in the buttock area by promoting collagen and elastin activity",
    side: "right",
