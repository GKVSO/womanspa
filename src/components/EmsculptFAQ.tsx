...
const faqs = [
  {
    question: "Does EMSculpt Neo hurt?",
    answer:
      "No. EMSculpt Neo is generally well-tolerated. Most clients feel intense muscle contractions and a warming sensation in the treated area, similar to an intense workout, but without pain.",
  },
  {
    question: "Is there any downtime?",
    answer:
      "There is zero downtime. You can return to your daily activities immediately after your EMSculpt Neo session.",
  },
  {
    question: "How many sessions are recommended?",
    answer:
      "Most clients achieve optimal results with a series of sessions, typically spaced several days apart. Your provider will design a personalized treatment plan based on your goals during your consultation.",
  },
  {
    question: "Can EMSculpt Neo replace exercise?",
    answer:
      "EMSculpt Neo is not a replacement for exercise or a healthy lifestyle. It is a body sculpting treatment designed to enhance muscle tone and reduce fat in targeted areas.",
  },
  {
...
export default function EmsculptFAQ() {
  const t = useT();
    ...
    >
      <FadeIn as="div" y={30}>
        <h2 className="text-[#313242] text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] leading-tight font-berlingske font-normal text-center">
          {t("Emsculpt Neo Questions Clients Often Ask")}
        </h2>
      </FadeIn>
