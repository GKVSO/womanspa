...
export default function CandelaSmootherCandidate() {
  const t = useT();
  return (
    <section
    ...
    >
      <StaggerContainer staggerDelay={0.12} className="max-w-[760px]">
        ...
        <StaggerItem>
          <img
            src="/CandelaSmoother-group-40575.svg"
            alt=""
        ...
        <StaggerItem>
          <p className="text-white font-medium text-[15px] sm:text-[18px] leading-relaxed mt-6 max-w-[700px]">
            {t("CandelaSmoother Matrix combines multiple RF technologies designed to target")}
            <br />
        ...
        <StaggerItem>
          <img
            src="/CandelaSmoother-group-40576.svg"
            alt=""
            className="w-16 h-16 mt-8"
          />
        </StaggerItem>
        ...
        <FadeIn as="div" y={30}>
          <motion.div className="bg-white/80 rounded-t-[30px] w-full sm:w-[620px] p-6 sm:p-10 backdrop-blur-sm">
            ...
            <div className="flex justify-center items-center py-10">
              <Image
                src="/CandelaSmoother-card-circle.png"
