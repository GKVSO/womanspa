...
export default function ExionBenefits({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
    ...
    >
      ...
      >
        <Image
          ...
          width={779}
          height={1341}
          className="h-[320px] sm:h-[720px] w-auto"
        />
      </motion.div>

      <div
        ref={cardsRef}
        className="relative z-20 -mt-12 sm:-mt-24 lg:-mt-[220px] w-full "
      >
        <div
