...
const reviews: Review[] = [
  ...
  },
  {
    ...
    text: "NAD+ Therapy changed my daily routine. I have so much more energy and focus throughout the day. It's truly been life-changing for my career and workouts.",
    name: "Sarah Johnson",
    initials: "SJ",
    stars: 5,
  },
  {
    ...
    text: "After years of dealing with chronic fatigue and brain fog, NAD+ infusions have completely cleared my mind. The staff was gentle and professional.",
  ...
  },
  {
    id: 4,
    category: "Wellness",
    title: "Mental Clarity Restored",
    text: "I was skeptical at first, but the results are incredible. I feel so much more confident and focused. My memory and cognitive functions are sharper than ever.",
  ...
  },
  {
    id: 5,
    category: "Anti-Aging",
    title: "Feeling Youthful Again",
    text: "My friends keep asking what I did! The NAD+ treatments are top-notch and the results speak for themselves, truly amazing recovery times.",
    name: "Jessica Brown",
    initials: "JB",
    stars: 5,
  },
  {
    id: 6,
    category: "Wellness",
    title: "A Complete Reset",
    text: "I wanted a way to reset my body after a stressful year. NAD+ provided exactly that. I feel refreshed, energized, and ready to tackle anything.",
...
export default function NadTherapyReviewsSlider() {
  const t = useT();
