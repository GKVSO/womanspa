...
export default function NadTherapyProcess() {
  const t = useT();
  return (
    <section className="relative overflow-hidden px-5 sm:px-10 pt-16 sm:pt-20 my-15 my:mt-25 lg:my-30 bg-[#eae8eb] rounded-[60px] bg-cover bg-[70%] lg:bg-[50%] min-[1200px]:bg-center md:bg-[url(/nad-process-bg.png)] bg-no-repeat">
      ...
      <div className="flex md:hidden justify-center">
        <img src="/nad-process.png" alt="NAD+ IV booster drip bag on an infusion stand for intravenous therapy." />
      </div>
    </section>
  );
}
