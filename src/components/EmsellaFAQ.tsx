...
const faqs = [
  {
    question: "Is EMSELLA painful?",
    answer:
      "No. EMSELLA is a comfortable, non-invasive treatment. Most clients describe a mild contracting or pulling sensation during the session, with no anesthesia required.",
  },
  {
    question: "Do I need downtime?",
    answer:
  ...
  },
  {
    ...
    answer:
      "A single EMSELLA session lasts approximately 28 minutes, designed to fit comfortably into your schedule.",
  },
  {
  ...
  {
    question: "Can EMSELLA help after childbirth or menopause?",
    answer:
      "Yes. EMSELLA is designed to support the pelvic floor through various life stages, including postpartum recovery and menopause-related changes.",
  },
  {
    question: "Do I remain clothed during treatment?",
    answer:
      "Yes. EMSELLA is a fully clothed treatment. You remain comfortably seated while the technology works.",
  },
];

export default function EmsellaFAQ() {
  const t = useT();
...
<h2 className="text-[#313242] text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] leading-tight font-berlingske font-normal text-center">
          {t("Emsella Questions Clients Often Ask")}
        </h2>
      </FadeIn>
