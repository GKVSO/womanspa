...
const cards = [
  {
    title: "More Defined Abdomen",
    text: "Popular for clients wanting a tighter-looking core",
  },
  {
    title: "Glute Enhancement",
    text: "Supports a firmer and more lifted appearance",
  },
  {
    title: "More Athletic Shape",
    text: "Designed to help improve visible muscle definition",
  },
  {
...
export default function EmsculptBenefits({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={cmsImage || "/emsculpt-benefits-body.webp"}
          alt={t("EMSculpt Neo results")}
          width={600}
          height={900}
