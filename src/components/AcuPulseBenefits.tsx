...
const cards = [
  ...
  },
  {
    ...
    text: "Many clients feel more comfortable wearing less makeup and showing their natural skin",
  },
];
...
export default function AcuPulseBenefits({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={cmsImage || "/acupulse-benefits.webp"}
          alt={t("AcuPulse results")}
          width={600}
          height={900}
