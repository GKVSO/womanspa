        ...
        <StaggerContainer staggerDelay={0.12}>
          <StaggerItem>
            <h2 className="text-black text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] font-berlingske leading-tight mb-6 text-center">
              {t("Reviews &amp; Client Experience")}
            </h2>
          </StaggerItem>

          <StaggerItem>
            <motion.div className="flex flex-wrap gap-3 justify-center mb-10" role="tablist" aria-label={t("Filter by category")}>
              {filters.map((filter) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`font-semibold text-[14px] rounded-full px-6 py-3 transition-colors cursor-pointer whitespace-nowrap ${
                      isActive
