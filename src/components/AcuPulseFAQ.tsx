...
const faqs = [
  {
    question: "Does CO2 Laser Resurfacing hurt?",
    answer:
      "The treatment is generally well-tolerated. Your provider will ensure your comfort throughout the procedure, and topical numbing is typically applied beforehand.",
  },
  {
    question: "How long is downtime?",
    answer:
      "Downtime varies depending on treatment intensity, but most clients can return to normal activities within a short recovery window as the skin heals and renews.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Results develop gradually as collagen remodels and new skin forms. Most clients notice visible improvements within the following weeks and continue to improve over time.",
  },
  {
    question: "Is CO2 safe for all skin types?",
    answer:
      "CO2 laser resurfacing is suitable for many skin types. Your provider will assess your skin during a consultation to determine the safest and most effective approach for you.",
  },
  {
    question: "Can CO2 be combined with other treatments?",
    answer:
      "Yes. CO2 laser resurfacing can safely complement other treatments to enhance overall results. Your provider will tailor a plan to your individual needs.",
  },
];

export default function AcuPulseFAQ() {
  const t = useT();
    ...
    >
      <FadeIn as="div" y={30}>
        <h2 className="text-[#313242] text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] leading-tight font-berlingske font-normal text-center">
          {t("CO2 Laser Resurfacing Frequently Asked Questions")}
        </h2>
      </FadeIn>
