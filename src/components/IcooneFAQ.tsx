...
const faqs = [
  {
    question: "Is ICOONE painful?",
    answer:
      "No. ICOONE is a comfortable, non-invasive procedure. Most clients describe a pleasant deep-tissue massage-like sensation during the session, with no anesthesia and no downtime required.",
  },
  {
  ...
  {
    question: "Can ICOONE replace surgery?",
    answer:
      "ICOONE is a non-invasive alternative designed to improve body contouring, lymphatic drainage, and skin firmness without surgery or downtime. For more advanced concerns, your provider will recommend the best approach for you.",
  },
  {
    question: "Can ICOONE be combined with other treatments?",
    answer:
      "Yes. ICOONE can safely complement other treatments to enhance overall results. Your provider will tailor a plan to your individual needs.",
  },
];

export default function IcooneFAQ() {
  const t = useT();
    ...
    >
      <FadeIn as="div" y={30}>
        <h2 className="text-[#313242] text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] leading-tight font-berlingske font-normal text-center">
          {t("Icoone Frequently Asked Questions")}
        </h2>
      </FadeIn>
