...
const faqs = [
  {
    question: "Is SylfirmX painful?",
    answer:
      "No. SylfirmX is a comfortable, non-invasive procedure. Most clients describe a mild warming sensation during the session, with no anesthesia required.",
  },
  {
  ...
  {
    question: "Can SylfirmX help improve skin tone and texture?",
    answer:
      "Yes. SylfirmX is designed to help improve overall skin quality, including tone, texture, redness, and the appearance of pores.",
  },
  {
    question: "How long are treatments?",
    answer:
      "Treatment sessions are typically quick and comfortable, allowing you to fit them easily into your schedule.",
  },
  {
    question: "When will I see results?",
    answer:
      "Results develop gradually as the skin renews. Most clients notice visible improvements within the following weeks and continue to improve over time.",
  },
];

export default function SylfirmFAQ() {
  const t = useT();
    ...
    >
      <FadeIn as="div" y={30}>
        <h2 className="text-[#313242] text-[24px] min-[768px]:text-[32px] min-[1200px]:text-[36px] min-[1600px]:text-[48px] leading-tight font-berlingske font-normal text-center">
          {t("SylfirmX Questions Clients Often Ask")}
        </h2>
      </FadeIn>
