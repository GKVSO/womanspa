      ...
      <FadeIn as="div" className="flex flex-col lg:flex-row gap-10 lg:gap-12 max-w-[1440px] mx-auto" y={30}>
        <div className="flex-1">
          <StaggerContainer staggerDelay={0.1}>
            <StaggerItem>
              <h2 className="text-black text-[48px] font-berlingske leading-tight mb-8">
                {t("Book Your Private BodyContouring Consultation")}
              </h2>
            </StaggerItem>
            ...
            <StaggerItem>
              ...
              <ul className="space-y-2 mb-8">
                {[
                  "Comprehensive body contour assessment",
                  "Fat, muscle, and skin quality evaluation",
        ...
        <div className="flex-1">
          <motion.div
            className="bg-white rounded-t-[40px] sm:rounded-t-[60px] p-6 sm:p-10 shadow-lg"
