...
export default function IvTherapyHero({ cms, editing }: { cms?: Record<string, unknown>; editing?: boolean }) {
  const t = useT();
  ...
  return (
    <section
      {...e("section","hero")}
      className={`bg-cover bg-no-repeat bg-bottom lg:bg-right rounded-b-[60px] px-5 sm:px-10 pt-20 sm:pt-24 pb-10 sm:pb-145 lg:pb-16 min-h-[100vh] flex flex-col overflow-hidden bg-[url(/nad-bg-mobile.png)] sm:bg-[url(/nad-bg-table.png)] lg:bg-[url(/nad-bg.png)]  ${editing ? "cursor-pointer hover:ring-2 hover:ring-white" : ""}`}
